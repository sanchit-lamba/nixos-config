...
{ pkgs, inputs, ...}: let
  ...
  # System Packages
    ...
    # Keep some useful applications from original config
    gh
    vscode
    obsidian
    stremio
...
fonts = {
  packages = with pkgs; [
    ...
    terminus_font
    victor-mono
    # Using stable branch compatible fonts
    (nerdfonts.override {fonts = ["JetBrainsMono" "FiraCode" "FantasqueSansMono"];}) # stable branch
    ];
  };
